...
2. **Quick EA search**: EA (Evolutionary Action) scores predicts the functional impact of protein coding mutations ([ref](https://genome.cshlp.org/content/24/12/2050.long)). This module allows user to quickly search the EA score of any given mutations in the selected reference genome.
...
## Related References
[Wang C, Govindarajan H, Katsonis P, Lichtarge O. ShinyBioHEAT: an interactive shiny app to identify phenotype driver genes in E.coli and B.subtilis. Bioinformatics. 2023 Aug 1;39(8):btad467.](https://academic.oup.com/bioinformatics/article/39/8/btad467/7234070)
