...
The goal of ShinyBioHEAT is to provide a shiny interface to allow users to predict phenotype driver gene in lab evolved *E. coli* strains using Evolutionary Action. A live version of the application is hosted at [http://bioheat.lichtargelab.org](http://bioheat.lichtargelab.org).
...
2. **Quick EA search**: EA (Evolutionary Action) scores predicts the functional impact of protein coding mutations ([ref](https://genome.cshlp.org/content/24/12/2050.long)). This module allows user to quickly search the EA score of any given mutations in the *E. coli* MG1655 genome.
